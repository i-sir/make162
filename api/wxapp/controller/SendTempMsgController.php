...
class SendTempMsgController extends AuthController
{
     ...
     * @return string
     */
    function processString($str = '', $limit = 18)
    {
     ...
     *
     *
     *   test_environment: http://make162.ikun:9090/api/wxapp/send_temp_msg/find_official
     *   official_environment: https://dzam162.wxselling.net/api/wxapp/send_temp_msg/find_official
    ...
    public function find_official()
    {
        ...
        if ($getMsgType == 'text') {
            ...
            //域名
            $domain_name              = cmf_config('domain_name');
            $address_official_account = $domain_name . '/h5';
            //跳转公众号
            $aLink     = '<a target="_blank" href="' . $address_official_account . '">点我下单</a>';
            $send_data = [
                'ToUserName'   => $openid,
                'FromUserName' => $getToOpenid,
                'CreateTime'   => time(),
                'MsgType'      => 'text',
                'Content'      => "欢迎关注{$app_name},{$aLink}",
            ];
     ...
     *
     *   test_environment: http://make162.ikun:9090/api/wxapp/send_temp_msg/qrcode_create
     *   official_environment: https://dzam162.wxselling.net/api/wxapp/send_temp_msg/qrcode_create
     ...
     * @return  string
     *
     *   test_environment: http://make162.ikun:9090/api/wxapp/send_temp_msg/sendTempMsg
     *   official_environment: https://dzam162.wxselling.net/api/wxapp/send_temp_msg/sendTempMsg
     ...
     *
     *
     *   test_environment: http://make162.ikun:9090/api/wxapp/send_temp_msg/send_temp_msg_test
     *   official_environment: https://dzam162.wxselling.net/api/wxapp/send_temp_msg/send_temp_msg_test
    ...
    public function send_temp_msg_test($openid = '', $template_id = '', $send_data = [], $pagepath = 'pages/index/index', $type = 1, $urls = '', $color = '#173177')
    {
        $openid      = '**********';
        $template_id = '*******';
        $urls        = cmf_get_domain() . "/h5/#/pages/technician/orderDetail?orderNum=1111";
        $send_data   = [
            'first'    => ['value' => '您好，您有一个订单'],
     ...
     *
     *   test_environment: http://make162.ikun:9090/api/wxapp/send_temp_msg/addWeixinMenu
     *   official_environment: https://dzam162.wxselling.net/api/wxapp/send_temp_msg/addWeixinMenu
     ...
     *
     *   test_environment: http://make162.ikun:9090/api/wxapp/send_temp_msg/batch_get_material
     *   official_environment: https://dzam162.wxselling.net/api/wxapp/send_temp_msg/batch_get_material
     ...
     *
     *   test_environment: http://make162.ikun:9090/api/wxapp/send_temp_msg/get_stable_access_token
     *   official_environment: https://dzam162.wxselling.net/api/wxapp/send_temp_msg/get_stable_access_token
