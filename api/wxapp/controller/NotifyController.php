...
class NotifyController extends AuthController
{
     ...
     * 微信支付回调 测试
     *
     *   test_environment: http://make162.ikun:9090/api/wxapp/notify/wx_pay_notify_test?pay_num=1000
     *   official_environment: https://dzam162.wxselling.net/api/wxapp/notify/wx_pay_notify_test?pay_num=1000
